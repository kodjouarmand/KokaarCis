...
using KokaarCis.Mvc.ActionFilters;
...
namespace KokaarCis.Mvc.Extensions
{
    public static class MvcServiceExtensions
    {
        ...
        public static void ConfigureJWT(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            string secretKey = "KokaarCisSecretKey";// Environment.GetEnvironmentVariable("SECRET");
