...
namespace KokaarCis.Api.Initializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        //private void InitializeLandTitle()
        //{
        //    if (!_dbContext.LandTitles.Any(u => u.Number.Equals(ConstantHelper.DEFAULT_LAND_TITLE_NUMBER)))
        //    {
        //        LandTitle landTitle = new()
        //        {
        //            Number = ConstantHelper.DEFAULT_LAND_TITLE_NUMBER,
        //            Owner = "INDEFINI",
        //            Locality = "INDEFINI"
        //        };
        //        _dbContext.Add(landTitle);
        //    }
        //}
