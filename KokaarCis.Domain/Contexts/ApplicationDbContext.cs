...
namespace KokaarCis.Domain.Contexts
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, Guid>
    {
        ...
        private static void AddUniqueKeyConstraints(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<InvoicePayment>().HasIndex(u => u.TransactionNumber).IsUnique();
            modelBuilder.Entity<CommissionPayment>().HasIndex(u => u.TransactionNumber).IsUnique();
        }
    }
}
